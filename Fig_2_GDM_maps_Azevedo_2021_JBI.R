...
worldMap = cerrado_layers[[13]] # Spatialpolygon dataframe object delimiting the continental borders without small islands
...
# Assigning colors for the dendrogram branches. This demands a bit of manual work to assigning divergent colors to increasingly distant clusters if you are using your own dataset.
...
#reptiles_plot # The dendrogram is added only at the final plot due to adjustments in the positions of each figure.
